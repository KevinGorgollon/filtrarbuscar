...
function llenarSelect() {
    ...
    for (let i = max; i >= min; i--) {
        ...
        year.appendChild(opcion); // Agrega las opciones de anios al select
    }
}
...
function filtrarAuto() {
    const resultado = autos.filter(filtraMarca).filter(filtrarYear).filter(filtrarMinimo).filter(
